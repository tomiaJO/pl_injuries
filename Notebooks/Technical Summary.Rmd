...
The aim of this analysis is to identify direct links between injury risk of professional soccer players and certain relatable factors.  
...
While it was not possible to establish an accurate prediction system for individual injuries, this paper demonstrates that there are other valuable insights that coudl be gathered. Among the most important ones are the impact of past injuries on future risk.  

The last section contains suggestions for future work, amongs them an interesting concept of investigating injuries in multiple-day time windows, rather than treating them as in-game occurances.  
\pagebreak
...
For the injury prediction problem, two aspects will be reviewed: differences of times (years), and differences among teams.
