...
For each variable, there are 3 charts (from left to right):  
1. Average injury rates (red line) and game counts (blue bar) in a given category  
2. 95% confidence interval of injury rates in a given category  
3. Average injury length in a given category, breaken out by injury type  
