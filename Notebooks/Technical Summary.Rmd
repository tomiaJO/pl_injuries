...
```{r, out.width = '75%', fig.align = 'center'}
include_graphics("C:/Users/tkonc/Documents/pl_injuries/Figures/1000g. Injuries vs injury history.jpeg")
```
...
The coefficients are in line with what the visual analysis already confirmed, e.g. the importance of injuries before, or the reverse impact of non-PL games played.
