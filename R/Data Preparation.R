...
f_save_plots(save_plots, p_hamstring_vs_year, "13", "Hamstring Injury vs Year", 6, 4.5)
...
f_breakdown_by_variable(injuries, "Position")


f_breakdown_by_variable(injuries, "Foot")
